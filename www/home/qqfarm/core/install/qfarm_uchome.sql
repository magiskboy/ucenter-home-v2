--
-- QQFarm tables with uchome_ prefix (for manual import into UCHome DB)
-- Replace app_qqfarm_ with uchome_qqfarm_ to match UCHome tablepre
--

CREATE TABLE IF NOT EXISTS `uchome_qqfarm_market` (
...
CREATE TABLE IF NOT EXISTS `uchome_qqfarm_mc` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `uchome_qqfarm_mclogs` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `uchome_qqfarm_message` (
...
CREATE TABLE IF NOT EXISTS `uchome_qqfarm_nc` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL DEFAULT '0',
  `status` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `uchome_qqfarm_nclogs` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL,
  `type` tinyint(2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `uchome_qqfarm_user` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL DEFAULT '0',
